class AppStrings {
  ...
  static const String invalidVoiceNumberInput = "Je n'ai pas compris votre réponse. Veuillez dire clairement un nombre.";
  static const String invalidVoiceInput = "Je n'ai pas compris votre réponse. Veuillez dire un nombre.";
  ...
  static const String invalidVoiceTrueFalseInput = "Je n'ai pas compris votre réponse. Veuillez dire 'vrai' ou 'faux'.";
  ...
  static const String mathExpressionParseError = "Je n'ai pas compris votre demande, reformulez votre proposition mathématique : {0}";
